...
Route::middleware('auth')->group(callback: function () {
    ...
    Route::get('dashboard/usuarios', [QuestionarioController::class, 'usuarios'])->name('dashboard.usuarios');
    ...
    Route::get('dashboard/ficha/{id}', [QuestionarioController::class, 'show'])->name('dashboard.show'); 
